...
def returns_plot(dates: List[str], time_step: str) -> None:
    ...
    try:
        ...
        # Plotting
        exact_distributions_covariance_tools.save_plot(
...
def aggregated_dist_returns_market_plot(dates: List[str], time_step: str) -> None:
    ...
    try:
        ...
        gaussian: np.ndarray = (
            exact_distributions_covariance_tools.gaussian_distribution(0, 1, x_gauss)
        )
...
def pdf_gg_plot(dates: List[str], time_step: str, N_values: List[int]) -> None:
    ...
    try:
        ...
        for N_val in N_values:
            ...
            plt.semilogy(x_val, gg_distribution, "-", lw=1, label=f"GG - N = {N_val}")
...
def pdf_loglog_gg_plot(dates: List[str], time_step: str, N_values: List[int]) -> None:
    ...
    try:
        ...
        for N_val in N_values:
            ...
            plt.loglog(x_val, gg_distribution, "-", lw=1, label=f"GG - N = {N_val}")
...
def pdf_ga_plot(
    dates: List[str], time_step: str, L_values: List[int], N_values: List[int]
) -> None:
        ...
        for N_val in N_values:
            ...
            ga_distribution: np.ndarray = (
                exact_distributions_covariance_tools.pdf_gaussian_algebraic(
                    x_val, K_value, L_value, N_val, 1
                )
            )
            plt.semilogy(x_val, ga_distribution, "-", lw=1, label=f"GA - N = {N_val}")
...
def pdf_lin_all_distributions_plot(dates: List[str], time_step: str) -> None:
    ...
    try:
        ...
        if dates[0] == "1972-01":
            ...
            gg_distribution: np.ndarray = (
                exact_distributions_covariance_tools.pdf_gaussian_gaussian(x_val, N, 1)
            )
