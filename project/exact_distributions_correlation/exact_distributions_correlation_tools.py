'''Exact distributions correlation tools module.
...
def save_data(data: Any, function_name: str, dates: List[str],
    ...
    exact_distributions_correlation_analysis module in pickle files.
    ...
    pickle.dump(data, open(
        f'../data/exact_distributions_correlation/{function_name}_{dates[0]}'
...
def save_plot(figure: plt.Figure, function_name: str, dates: List[str],
    ...
    figure.savefig(f'../plot/exact_distributions_correlation/{function_name}'
...
def start_folders() -> None:
    ...
    try:
        os.mkdir('../data/exact_distributions_correlation')
        os.mkdir('../plot/exact_distributions_correlation')
